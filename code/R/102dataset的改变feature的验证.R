...
colnames(test.matrix)=feature.name182
...
#######合并数据矩阵#########
train.102matrix182=cbind(train.matrix123,train.matrix59)
test.102matrix182=cbind(test.matrix123,test.matrix59)
##PLD-DA分析
#result=pca(train.102matrix182, ncomp = 10, center = TRUE, scale = TRUE)
#plot(result)
spls.train.182feature=splsda(train.102matrix182,train.class2,ncomp=3,scale=TRUE)
